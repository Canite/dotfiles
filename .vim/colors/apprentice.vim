...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  if ($TERM_PROGRAM == 'iTerm.app')
    ...
    hi MatchParen     ctermbg=105  ctermfg=229  guibg=#1c1c1c guifg=#ffffaf cterm=NONE           gui=NONE
  ...
  hi StatusLine       ctermbg=17  ctermfg=105  guibg=#87875f  guifg=#262626 cterm=NONE           gui=NONE
